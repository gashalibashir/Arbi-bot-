...
console.error(“MEXC response not array:”, JSON.stringify(data).substring(0, 200));
return map;
}
...
console.error(“MEXC fetch failed: “ + e.message);
return {};
});
}
...
console.error(“Bybit response invalid:”, JSON.stringify(data).substring(0, 200));
return map;
}
...
console.log(“MEXC: “ + mexcTotal + “ Bybit: “ + bybitTotal + “ Common: “ + common);

if (mexcTotal === 0 && bybitTotal === 0) {
await sendTG(“Both APIs failed to respond. Will retry next cycle.”);
process.exit(1);
}
